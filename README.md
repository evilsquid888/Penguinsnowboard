...
**Approximate reading time: 10 minutes per story.**
...
|---|---|---|---|
| 1 | [The Great Slush Flood](stories/story_01_the_great_slush_flood.md) | Noah's Ark | Trust & new beginnings |
| 2 | [Willa and the Giant Snowball](stories/story_02_willa_and_the_giant_snowball.md) | David & Goliath | Courage over size |
| 3 | [The Penguin Left on the Slope](stories/story_03_the_penguin_left_on_the_slope.md) | The Good Samaritan | Kindness to strangers |
| 4 | [Finnegan Goes the Wrong Way](stories/story_04_finnegan_goes_the_wrong_way.md) | Jonah & the Whale | Second chances |
| 5 | [The First Morning on Frostpeak](stories/story_05_the_first_morning_on_frostpeak.md) | The Creation | Wonder & gratitude |
| 6 | [Piper and the Parting Snow](stories/story_06_piper_and_the_parting_snow.md) | Moses & the Red Sea | Faith in impossible moments |
| 7 | [Cleo and the Frozen Lions](stories/story_07_cleo_and_the_frozen_lions.md) | Daniel in the Lions' Den | Stay true to yourself |
...
## Characters & World Guide

See the full [Character & Story Guide](CHARACTER_AND_STORY_GUIDE.md) for:
- Detailed character profiles for all penguins and polar bears
- Descriptions of recurring locations in Frostpeak Valley
- Reading tips for grown-ups
- Full Bible story reference table

---

## How to Use This Collection

- **Read one story per night** — each is designed for a single bedtime session
- End with the **Goodnight Blessing** at a slow, whispered pace
- Use the **Image Prompts** with any AI image generator to create custom illustrations
- Use the **Video Prompts** with any AI video tool to create animated sequences
- The stories work best read in order (the characters grow across the series) but each stands alone
